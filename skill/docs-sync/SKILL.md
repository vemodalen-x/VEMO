...
here instead of editing docs directly. (Generalizes Wildpanda's `readme-update` from README-only to all docs.)

**When**
- auto: during `governance-release` / `governance-contribute`; when a skill, command, or version changes.
- manual: "update docs", "sync readme", "refresh the guide", "更新文档 / 同步 readme".
...
- **Consistency** — README ↔ `docs/GUIDE.html` ↔ `docs/MENTAL_MODEL.html` say the same thing.

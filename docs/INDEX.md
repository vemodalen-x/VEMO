...
| **See how it differs from Wildpanda** | Explanation | [VS_WILDPANDA.md](VS_WILDPANDA.md) |
...
| **See why it's designed this way** | Explanation | [ITERATION_LOG.html](ITERATION_LOG.html) (3-perspective design) · [VEMO_REVIEW_EN.html](VEMO_REVIEW_EN.html) (critical review + score) |
